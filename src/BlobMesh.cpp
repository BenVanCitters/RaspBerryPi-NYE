...
//            if( ( x + 1 < mMeshWidth ) && ( y + 1 < mMeshHeight ) )
            {
                ...
                mIndicies[curIndex+0] =(y+0) * mMeshHeight + (x+0);
//                indices.push_back( (y+0) * mMeshHeight + (x+0) );
                mIndicies[curIndex+1] =(y+1) * mMeshHeight + (x+0);
//                indices.push_back( (y+1) * mMeshHeight + (x+0) );
                mIndicies[curIndex+2] =(y) * mMeshHeight + (x+1);
//                indices.push_back( (y) * mMeshHeight + (x+1) );
                
                mIndicies[curIndex+3] =(y+0) * mMeshHeight + (x+1);
//                indices.push_back( (y+0) * mMeshHeight + (x+1) );
                mIndicies[curIndex+4] =(y+1) * mMeshHeight + (x+0);
//                indices.push_back( (y+1) * mMeshHeight + (x+0) );
                mIndicies[curIndex+5] =(y+1) * mMeshHeight + (x+1);
...
//    gl::scale( Vec3f( 200,200,200 ) );
    ofScale(200,200,200);
    mVboMesh.draw(GL_TRIANGLES, 0, mMeshWidth*mMeshHeight*2);
